...
namespace BTD6CustomizationItems.Items
{
    class Factory : ModTower<ItemsSet>
    {
        ...
        {
            return towerSet.First(model => model.towerId == TowerType.EngineerMonkey).towerIndex + 3;
        }

        public override string Icon => "FactoryImage";
        public override string Portrait => "FactoryImage";
    }
}