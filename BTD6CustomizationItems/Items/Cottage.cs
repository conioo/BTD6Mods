...
{
    class Cottage : ModTower<ItemsSet>
    {
        public override string BaseTower => TowerType.CaveMonkey;
        public override string Description => "Cottage";
        ...
        {
            return towerSet.First(model => model.towerId == TowerType.EngineerMonkey).towerIndex + 4;
        }

        public override string Icon => "CottageImage";
        public override string Portrait => "CottageImage";
    }
}