...
namespace BTDBattles2Maps.Maps
{
    class Inflection
    {
        public static Il2CppReferenceArray<PointInfo> mainTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)150.1, (float)-69.2));
            list.Add(MapHelper.AddPoint((float)139.6, (float)-68.6));
            list.Add(MapHelper.AddPoint((float)130.5, (float)-67.4));
            list.Add(MapHelper.AddPoint((float)123.2, (float)-66.2));
            list.Add(MapHelper.AddPoint((float)115.4, (float)-63.1));
            list.Add(MapHelper.AddPoint((float)109.6, (float)-59.8));
            list.Add(MapHelper.AddPoint((float)102.1, (float)-55.9));
            list.Add(MapHelper.AddPoint((float)97.1, (float)-50.8));
            list.Add(MapHelper.AddPoint((float)92.7, (float)-47.2));
            list.Add(MapHelper.AddPoint((float)88.5, (float)-43.3));
            list.Add(MapHelper.AddPoint((float)84.9, (float)-36.4));
            list.Add(MapHelper.AddPoint((float)81.8, (float)-29.5));
            list.Add(MapHelper.AddPoint((float)79.9, (float)-23.2));
            list.Add(MapHelper.AddPoint((float)77.1, (float)-15.3));
            list.Add(MapHelper.AddPoint((float)76.3, (float)-3.0));
            list.Add(MapHelper.AddPoint((float)76.0, (float)4.2));
            list.Add(MapHelper.AddPoint((float)74.5, (float)14.7));
            list.Add(MapHelper.AddPoint((float)74.2, (float)28.3));
            list.Add(MapHelper.AddPoint((float)74.0, (float)33.7));
            list.Add(MapHelper.AddPoint((float)72.1, (float)38.8));
            list.Add(MapHelper.AddPoint((float)70.8, (float)43.9));
            list.Add(MapHelper.AddPoint((float)67.4, (float)51.7));
            list.Add(MapHelper.AddPoint((float)62.5, (float)58.9));
            list.Add(MapHelper.AddPoint((float)58.6, (float)65.0));
            list.Add(MapHelper.AddPoint((float)52.3, (float)71.3));
            list.Add(MapHelper.AddPoint((float)47.9, (float)75.8));
            list.Add(MapHelper.AddPoint((float)41.4, (float)79.1));
            list.Add(MapHelper.AddPoint((float)32.3, (float)83.3));
            list.Add(MapHelper.AddPoint((float)24.5, (float)86.6));
            list.Add(MapHelper.AddPoint((float)16.4, (float)88.1));
            list.Add(MapHelper.AddPoint((float)9.1, (float)89.0));
            list.Add(MapHelper.AddPoint((float)1.0, (float)90.2));
            list.Add(MapHelper.AddPoint((float)-4.9, (float)89.9));
            list.Add(MapHelper.AddPoint((float)-13.5, (float)88.4));
            list.Add(MapHelper.AddPoint((float)-21.4, (float)87.2));
            list.Add(MapHelper.AddPoint((float)-28.9, (float)84.8));
            list.Add(MapHelper.AddPoint((float)-35.9, (float)82.4));
            list.Add(MapHelper.AddPoint((float)-41.4, (float)79.7));
            list.Add(MapHelper.AddPoint((float)-47.9, (float)75.8));
            list.Add(MapHelper.AddPoint((float)-53.1, (float)71.9));
            list.Add(MapHelper.AddPoint((float)-58.3, (float)67.1));
            list.Add(MapHelper.AddPoint((float)-63.0, (float)61.3));
            list.Add(MapHelper.AddPoint((float)-66.1, (float)56.8));
            list.Add(MapHelper.AddPoint((float)-68.5, (float)50.2));
            list.Add(MapHelper.AddPoint((float)-71.6, (float)43.3));
            list.Add(MapHelper.AddPoint((float)-72.9, (float)37.6));
            list.Add(MapHelper.AddPoint((float)-75.0, (float)30.7));
            list.Add(MapHelper.AddPoint((float)-75.3, (float)23.5));
            list.Add(MapHelper.AddPoint((float)-75.5, (float)15.0));
            list.Add(MapHelper.AddPoint((float)-75.5, (float)6.3));
            list.Add(MapHelper.AddPoint((float)-75.5, (float)1.2));
            list.Add(MapHelper.AddPoint((float)-76.3, (float)-6.6));
            list.Add(MapHelper.AddPoint((float)-76.8, (float)-13.8));
            list.Add(MapHelper.AddPoint((float)-78.1, (float)-20.1));
            list.Add(MapHelper.AddPoint((float)-79.9, (float)-24.1));
            list.Add(MapHelper.AddPoint((float)-82.8, (float)-31.6));
            list.Add(MapHelper.AddPoint((float)-85.4, (float)-36.4));
            list.Add(MapHelper.AddPoint((float)-88.3, (float)-41.5));
            list.Add(MapHelper.AddPoint((float)-92.2, (float)-46.3));
            list.Add(MapHelper.AddPoint((float)-96.1, (float)-51.7));
            list.Add(MapHelper.AddPoint((float)-101.3, (float)-56.5));
            list.Add(MapHelper.AddPoint((float)-105.7, (float)-59.8));
            list.Add(MapHelper.AddPoint((float)-109.4, (float)-61.9));
            list.Add(MapHelper.AddPoint((float)-113.8, (float)-65.3));
            list.Add(MapHelper.AddPoint((float)-118.2, (float)-66.8));
            list.Add(MapHelper.AddPoint((float)-124.2, (float)-69.2));
            list.Add(MapHelper.AddPoint((float)-131.8, (float)-68.9));
            list.Add(MapHelper.AddPoint((float)-139.6, (float)-69.8));
            list.Add(MapHelper.AddPoint((float)-146.1, (float)-69.8));
            list.Add(MapHelper.AddPoint((float)-149.9, (float)-70.4));
        ...
        public static Il2CppReferenceArray<PointInfo> secondTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)149.5, (float)89.3));
            list.Add(MapHelper.AddPoint((float)116.9, (float)89.0));
            list.Add(MapHelper.AddPoint((float)90.9, (float)87.5));
            list.Add(MapHelper.AddPoint((float)68.8, (float)87.2));
            list.Add(MapHelper.AddPoint((float)50.5, (float)86.3));
            list.Add(MapHelper.AddPoint((float)40.9, (float)83.9));
            list.Add(MapHelper.AddPoint((float)32.8, (float)80.6));
            list.Add(MapHelper.AddPoint((float)21.6, (float)76.7));
            list.Add(MapHelper.AddPoint((float)16.7, (float)71.3));
            list.Add(MapHelper.AddPoint((float)11.5, (float)66.2));
            list.Add(MapHelper.AddPoint((float)7.0, (float)61.0));
            list.Add(MapHelper.AddPoint((float)4.4, (float)56.8));
            list.Add(MapHelper.AddPoint((float)2.1, (float)51.4));
            list.Add(MapHelper.AddPoint((float)0.5, (float)43.9));
            list.Add(MapHelper.AddPoint((float)-1.8, (float)34.0));
            list.Add(MapHelper.AddPoint((float)-2.6, (float)27.7));
            list.Add(MapHelper.AddPoint((float)-3.6, (float)18.0));
            list.Add(MapHelper.AddPoint((float)-4.2, (float)9.9));
            list.Add(MapHelper.AddPoint((float)-4.9, (float)2.1));
            list.Add(MapHelper.AddPoint((float)-6.5, (float)-9.0));
            list.Add(MapHelper.AddPoint((float)-9.4, (float)-18.6));
            list.Add(MapHelper.AddPoint((float)-13.0, (float)-26.8));
            list.Add(MapHelper.AddPoint((float)-16.1, (float)-33.4));
            list.Add(MapHelper.AddPoint((float)-20.1, (float)-39.1));
            list.Add(MapHelper.AddPoint((float)-26.3, (float)-45.4));
            list.Add(MapHelper.AddPoint((float)-30.7, (float)-49.6));
            list.Add(MapHelper.AddPoint((float)-35.4, (float)-53.5));
            list.Add(MapHelper.AddPoint((float)-41.7, (float)-56.2));
            list.Add(MapHelper.AddPoint((float)-48.2, (float)-59.5));
            list.Add(MapHelper.AddPoint((float)-57.0, (float)-62.5));
            list.Add(MapHelper.AddPoint((float)-65.9, (float)-64.7));
            list.Add(MapHelper.AddPoint((float)-72.1, (float)-65.3));
            list.Add(MapHelper.AddPoint((float)-90.4, (float)-67.7));
            list.Add(MapHelper.AddPoint((float)-102.1, (float)-68.9));
            list.Add(MapHelper.AddPoint((float)-113.3, (float)-69.5));
            list.Add(MapHelper.AddPoint((float)-125.3, (float)-68.9));
            list.Add(MapHelper.AddPoint((float)-131.8, (float)-68.9));
            list.Add(MapHelper.AddPoint((float)-139.6, (float)-69.8));
            list.Add(MapHelper.AddPoint((float)-146.1, (float)-69.8));
            list.Add(MapHelper.AddPoint((float)-149.9, (float)-70.4));
        ...
        public static Il2CppReferenceArray<AreaModel> areas()
        {
            ...
            newAreas.Add(new AreaModel("track0", new Assets.Scripts.Simulation.SMath.Polygon(trackMain), 10, AreaType.track));
            newAreas.Add(new AreaModel("track1", new Assets.Scripts.Simulation.SMath.Polygon(trackSecond), 10, AreaType.track));
