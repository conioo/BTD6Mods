...
namespace BTDBattles2Maps.Maps
{
    class Glade
    {
        public static Il2CppReferenceArray<PointInfo> mainTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)109.9, (float)115.5));
            list.Add(MapHelper.AddPoint((float)96.1, (float)107.4));
            list.Add(MapHelper.AddPoint((float)82.3, (float)104.0));
            list.Add(MapHelper.AddPoint((float)73.2, (float)99.2));
            list.Add(MapHelper.AddPoint((float)66.7, (float)92.3));
            list.Add(MapHelper.AddPoint((float)62.0, (float)87.8));
            list.Add(MapHelper.AddPoint((float)57.3, (float)77.0));
            list.Add(MapHelper.AddPoint((float)55.7, (float)66.2));
            list.Add(MapHelper.AddPoint((float)55.7, (float)56.2));
            list.Add(MapHelper.AddPoint((float)58.6, (float)46.9));
            list.Add(MapHelper.AddPoint((float)62.5, (float)36.7));
            list.Add(MapHelper.AddPoint((float)69.0, (float)28.9));
            list.Add(MapHelper.AddPoint((float)74.7, (float)24.1));
            list.Add(MapHelper.AddPoint((float)81.0, (float)18.3));
            list.Add(MapHelper.AddPoint((float)87.8, (float)9.3));
            list.Add(MapHelper.AddPoint((float)91.4, (float)3.9));
            list.Add(MapHelper.AddPoint((float)96.4, (float)-5.7));
            list.Add(MapHelper.AddPoint((float)98.4, (float)-10.5));
            list.Add(MapHelper.AddPoint((float)100.3, (float)-18.6));
            list.Add(MapHelper.AddPoint((float)99.2, (float)-35.5));
            list.Add(MapHelper.AddPoint((float)94.0, (float)-47.5));
            list.Add(MapHelper.AddPoint((float)89.1, (float)-53.5));
            list.Add(MapHelper.AddPoint((float)83.9, (float)-57.7));
            list.Add(MapHelper.AddPoint((float)78.1, (float)-61.3));
            list.Add(MapHelper.AddPoint((float)70.6, (float)-63.1));
            list.Add(MapHelper.AddPoint((float)57.0, (float)-61.9));
            list.Add(MapHelper.AddPoint((float)49.7, (float)-59.8));
            list.Add(MapHelper.AddPoint((float)43.2, (float)-56.5));
            list.Add(MapHelper.AddPoint((float)35.7, (float)-52.0));
            list.Add(MapHelper.AddPoint((float)28.1, (float)-44.8));
            list.Add(MapHelper.AddPoint((float)21.6, (float)-37.0));
            list.Add(MapHelper.AddPoint((float)13.8, (float)-27.7));
            list.Add(MapHelper.AddPoint((float)9.1, (float)-20.1));
            list.Add(MapHelper.AddPoint((float)0.0, (float)-5.7));
            list.Add(MapHelper.AddPoint((float)-16.1, (float)23.8));
            list.Add(MapHelper.AddPoint((float)-25.8, (float)39.7));
            list.Add(MapHelper.AddPoint((float)-38.0, (float)55.0));
            list.Add(MapHelper.AddPoint((float)-52.6, (float)67.4));
            list.Add(MapHelper.AddPoint((float)-65.9, (float)71.3));
            list.Add(MapHelper.AddPoint((float)-78.4, (float)72.5));
            list.Add(MapHelper.AddPoint((float)-89.8, (float)71.0));
            list.Add(MapHelper.AddPoint((float)-100.0, (float)65.3));
            list.Add(MapHelper.AddPoint((float)-108.3, (float)56.8));
            list.Add(MapHelper.AddPoint((float)-113.5, (float)47.5));
            list.Add(MapHelper.AddPoint((float)-119.0, (float)37.0));
            list.Add(MapHelper.AddPoint((float)-121.9, (float)23.2));
            list.Add(MapHelper.AddPoint((float)-121.4, (float)9.9));
            list.Add(MapHelper.AddPoint((float)-120.3, (float)-2.4));
            list.Add(MapHelper.AddPoint((float)-115.4, (float)-15.3));
            list.Add(MapHelper.AddPoint((float)-111.2, (float)-24.4));
            list.Add(MapHelper.AddPoint((float)-105.2, (float)-36.1));
            list.Add(MapHelper.AddPoint((float)-96.9, (float)-51.1));
            list.Add(MapHelper.AddPoint((float)-88.5, (float)-62.8));
            list.Add(MapHelper.AddPoint((float)-82.3, (float)-71.9));
            list.Add(MapHelper.AddPoint((float)-76.0, (float)-83.9));
            list.Add(MapHelper.AddPoint((float)-72.7, (float)-94.7));
            list.Add(MapHelper.AddPoint((float)-70.6, (float)-107.1));
            list.Add(MapHelper.AddPoint((float)-68.2, (float)-114.6));
        ...
        public static Il2CppReferenceArray<PointInfo> secondTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)150.1, (float)-46.3));
            list.Add(MapHelper.AddPoint((float)129.9, (float)-51.4));
            list.Add(MapHelper.AddPoint((float)114.1, (float)-55.9));
            list.Add(MapHelper.AddPoint((float)103.1, (float)-58.6));
            list.Add(MapHelper.AddPoint((float)92.4, (float)-60.4));
            list.Add(MapHelper.AddPoint((float)57.0, (float)-61.9));
            list.Add(MapHelper.AddPoint((float)49.7, (float)-59.8));
            list.Add(MapHelper.AddPoint((float)43.2, (float)-56.5));
            list.Add(MapHelper.AddPoint((float)35.7, (float)-52.0));
            ...
            list.Add(MapHelper.AddPoint((float)-78.4, (float)72.5));
            list.Add(MapHelper.AddPoint((float)-89.8, (float)71.0));
            list.Add(MapHelper.AddPoint((float)-97.9, (float)70.7));
            list.Add(MapHelper.AddPoint((float)-109.9, (float)69.8));
            list.Add(MapHelper.AddPoint((float)-123.4, (float)68.6));
            list.Add(MapHelper.AddPoint((float)-137.0, (float)65.6));
            list.Add(MapHelper.AddPoint((float)-149.9, (float)58.0));
