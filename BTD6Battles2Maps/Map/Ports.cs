...
namespace BTDBattles2Maps.Maps
{
    class Ports
    {
        public static Il2CppReferenceArray<PointInfo> mainTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)132.8, (float)115.5));
            list.Add(MapHelper.AddPoint((float)134.1, (float)-91.1));
            list.Add(MapHelper.AddPoint((float)134.1, (float)-95.3));
            list.Add(MapHelper.AddPoint((float)132.6, (float)-98.3));
            list.Add(MapHelper.AddPoint((float)130.2, (float)-100.7));
            list.Add(MapHelper.AddPoint((float)125.8, (float)-101.6));
            list.Add(MapHelper.AddPoint((float)47.4, (float)-101.9));
            list.Add(MapHelper.AddPoint((float)5.2, (float)-101.3));
            list.Add(MapHelper.AddPoint((float)2.1, (float)-101.0));
            list.Add(MapHelper.AddPoint((float)0.5, (float)-99.5));
            list.Add(MapHelper.AddPoint((float)-0.5, (float)-98.0));
            list.Add(MapHelper.AddPoint((float)-1.3, (float)-93.8));
            list.Add(MapHelper.AddPoint((float)-1.8, (float)-74.0));
            list.Add(MapHelper.AddPoint((float)-1.8, (float)-70.1));
            list.Add(MapHelper.AddPoint((float)-2.6, (float)-68.0));
            list.Add(MapHelper.AddPoint((float)-4.4, (float)-66.8));
            list.Add(MapHelper.AddPoint((float)-7.8, (float)-65.3));
            list.Add(MapHelper.AddPoint((float)-46.4, (float)-65.3));
            list.Add(MapHelper.AddPoint((float)-48.2, (float)-65.3));
            list.Add(MapHelper.AddPoint((float)-50.5, (float)-65.3));
            list.Add(MapHelper.AddPoint((float)-52.1, (float)-67.4));
            list.Add(MapHelper.AddPoint((float)-53.6, (float)-69.5));
            list.Add(MapHelper.AddPoint((float)-53.9, (float)-72.8));
            list.Add(MapHelper.AddPoint((float)-53.9, (float)-92.6));
            list.Add(MapHelper.AddPoint((float)-53.9, (float)-95.3));
            list.Add(MapHelper.AddPoint((float)-55.5, (float)-98.9));
            list.Add(MapHelper.AddPoint((float)-58.1, (float)-101.0));
            list.Add(MapHelper.AddPoint((float)-60.7, (float)-101.6));
            list.Add(MapHelper.AddPoint((float)-104.4, (float)-101.6));
            list.Add(MapHelper.AddPoint((float)-108.3, (float)-101.6));
            list.Add(MapHelper.AddPoint((float)-110.9, (float)-103.7));
            list.Add(MapHelper.AddPoint((float)-112.2, (float)-105.8));
            list.Add(MapHelper.AddPoint((float)-112.2, (float)-114.3));
        ...
        public static Il2CppReferenceArray<PointInfo> secondTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)125.8, (float)-101.6));
            list.Add(MapHelper.AddPoint((float)47.4, (float)-101.9));
            list.Add(MapHelper.AddPoint((float)44.8, (float)-101.6));
            list.Add(MapHelper.AddPoint((float)42.4, (float)-99.8));
            list.Add(MapHelper.AddPoint((float)41.7, (float)-97.7));
            list.Add(MapHelper.AddPoint((float)40.9, (float)-93.8));
            list.Add(MapHelper.AddPoint((float)39.8, (float)93.5));
            list.Add(MapHelper.AddPoint((float)39.3, (float)96.2));
            list.Add(MapHelper.AddPoint((float)38.5, (float)98.3));
            list.Add(MapHelper.AddPoint((float)37.2, (float)99.5));
            list.Add(MapHelper.AddPoint((float)33.6, (float)101.0));
            list.Add(MapHelper.AddPoint((float)-40.4, (float)101.9));
            list.Add(MapHelper.AddPoint((float)-43.2, (float)101.0));
            list.Add(MapHelper.AddPoint((float)-45.1, (float)99.5));
            list.Add(MapHelper.AddPoint((float)-46.9, (float)97.4));
            list.Add(MapHelper.AddPoint((float)-46.6, (float)93.8));
            list.Add(MapHelper.AddPoint((float)-48.2, (float)74.0));
            list.Add(MapHelper.AddPoint((float)-48.4, (float)70.7));
            list.Add(MapHelper.AddPoint((float)-49.7, (float)67.4));
            list.Add(MapHelper.AddPoint((float)-52.1, (float)67.1));
            list.Add(MapHelper.AddPoint((float)-54.4, (float)66.8));
            list.Add(MapHelper.AddPoint((float)-88.3, (float)66.2));
            list.Add(MapHelper.AddPoint((float)-91.4, (float)65.9));
            list.Add(MapHelper.AddPoint((float)-93.5, (float)67.4));
            list.Add(MapHelper.AddPoint((float)-94.0, (float)69.8));
            list.Add(MapHelper.AddPoint((float)-94.8, (float)73.1));
            list.Add(MapHelper.AddPoint((float)-95.8, (float)93.2));
            list.Add(MapHelper.AddPoint((float)-95.8, (float)96.2));
            list.Add(MapHelper.AddPoint((float)-97.4, (float)99.5));
            list.Add(MapHelper.AddPoint((float)-100.0, (float)101.0));
            list.Add(MapHelper.AddPoint((float)-103.1, (float)101.6));
            list.Add(MapHelper.AddPoint((float)-149.0, (float)102.5));
        ...
        public static Il2CppReferenceArray<AreaModel> areas()
        {
            ...
            newAreas.Add(new AreaModel("containers0", new Assets.Scripts.Simulation.SMath.Polygon(containers0), 10, AreaType.unplaceable));
            newAreas.Add(new AreaModel("containers1", new Assets.Scripts.Simulation.SMath.Polygon(containers1), 100, AreaType.unplaceable, 0f, null, null, null, true, false, default));
            newAreas.Add(new AreaModel("sewers", new Assets.Scripts.Simulation.SMath.Polygon(sewers), 10, AreaType.unplaceable));
