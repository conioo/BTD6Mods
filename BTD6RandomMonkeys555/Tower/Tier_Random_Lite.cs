...
{
    class Tier_Random_Lite : ModTower
    {
        public override string TowerSet => SUPPORT;
        public override string BaseTower => TowerType.SniperMonkey;
        public override string Description => "Random Tower Tier Random Lite";

        public override int Cost => Options.DefaultCostTierRandomLite;
