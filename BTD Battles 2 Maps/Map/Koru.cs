...
namespace BTDBattles2Maps.Maps
{
    class Koru
    {
        public static Il2CppReferenceArray<PointInfo> mainTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)-23.7, (float)-22.3));
            list.Add(MapHelper.AddPoint((float)-18.2, (float)-31.9));
            list.Add(MapHelper.AddPoint((float)-11.2, (float)-35.8));
            list.Add(MapHelper.AddPoint((float)-1.8, (float)-37.9));
            list.Add(MapHelper.AddPoint((float)6.8, (float)-37.3));
            list.Add(MapHelper.AddPoint((float)14.8, (float)-34.6));
            list.Add(MapHelper.AddPoint((float)22.9, (float)-29.2));
            list.Add(MapHelper.AddPoint((float)29.7, (float)-20.4));
            list.Add(MapHelper.AddPoint((float)33.1, (float)-10.5));
            list.Add(MapHelper.AddPoint((float)34.9, (float)1.2));
            list.Add(MapHelper.AddPoint((float)34.4, (float)10.2));
            list.Add(MapHelper.AddPoint((float)31.3, (float)18.0));
            list.Add(MapHelper.AddPoint((float)26.3, (float)30.1));
            list.Add(MapHelper.AddPoint((float)18.8, (float)37.6));
            list.Add(MapHelper.AddPoint((float)11.7, (float)43.0));
            list.Add(MapHelper.AddPoint((float)3.4, (float)46.3));
            list.Add(MapHelper.AddPoint((float)-5.5, (float)48.7));
            list.Add(MapHelper.AddPoint((float)-16.9, (float)49.3));
            list.Add(MapHelper.AddPoint((float)-23.4, (float)49.0));
            list.Add(MapHelper.AddPoint((float)-32.6, (float)45.4));
            list.Add(MapHelper.AddPoint((float)-42.2, (float)40.0));
            list.Add(MapHelper.AddPoint((float)-50.0, (float)33.7));
            list.Add(MapHelper.AddPoint((float)-56.0, (float)28.0));
            list.Add(MapHelper.AddPoint((float)-60.2, (float)21.3));
            list.Add(MapHelper.AddPoint((float)-63.8, (float)14.7));
            list.Add(MapHelper.AddPoint((float)-68.0, (float)5.4));
            list.Add(MapHelper.AddPoint((float)-69.0, (float)-6.9));
            list.Add(MapHelper.AddPoint((float)-69.8, (float)-15.6));
            list.Add(MapHelper.AddPoint((float)-68.8, (float)-25.0));
            list.Add(MapHelper.AddPoint((float)-66.7, (float)-36.4));
            list.Add(MapHelper.AddPoint((float)-63.0, (float)-45.7));
            list.Add(MapHelper.AddPoint((float)-59.1, (float)-54.7));
            list.Add(MapHelper.AddPoint((float)-52.6, (float)-65.0));
            list.Add(MapHelper.AddPoint((float)-44.8, (float)-72.2));
            list.Add(MapHelper.AddPoint((float)-35.9, (float)-77.9));
            list.Add(MapHelper.AddPoint((float)-25.8, (float)-80.3));
            list.Add(MapHelper.AddPoint((float)-11.7, (float)-83.6));
            list.Add(MapHelper.AddPoint((float)-5.5, (float)-83.9));
            list.Add(MapHelper.AddPoint((float)3.6, (float)-84.5));
            list.Add(MapHelper.AddPoint((float)9.1, (float)-84.5));
            list.Add(MapHelper.AddPoint((float)19.8, (float)-84.5));
            list.Add(MapHelper.AddPoint((float)27.3, (float)-80.9));
            list.Add(MapHelper.AddPoint((float)35.4, (float)-77.6));
            list.Add(MapHelper.AddPoint((float)42.2, (float)-74.3));
            list.Add(MapHelper.AddPoint((float)50.8, (float)-66.5));
            list.Add(MapHelper.AddPoint((float)56.0, (float)-58.9));
            list.Add(MapHelper.AddPoint((float)59.4, (float)-54.7));
            list.Add(MapHelper.AddPoint((float)64.6, (float)-44.8));
            list.Add(MapHelper.AddPoint((float)68.0, (float)-40.3));
            list.Add(MapHelper.AddPoint((float)71.1, (float)-32.2));
            list.Add(MapHelper.AddPoint((float)74.0, (float)-25.6));
            list.Add(MapHelper.AddPoint((float)76.6, (float)-18.0));
            list.Add(MapHelper.AddPoint((float)77.9, (float)-11.1));
            list.Add(MapHelper.AddPoint((float)79.2, (float)-2.1));
            list.Add(MapHelper.AddPoint((float)80.2, (float)2.1));
            list.Add(MapHelper.AddPoint((float)81.0, (float)7.8));
            list.Add(MapHelper.AddPoint((float)80.2, (float)18.3));
            list.Add(MapHelper.AddPoint((float)76.8, (float)29.8));
            list.Add(MapHelper.AddPoint((float)72.1, (float)38.8));
            list.Add(MapHelper.AddPoint((float)69.3, (float)46.6));
            list.Add(MapHelper.AddPoint((float)64.8, (float)55.0));
            list.Add(MapHelper.AddPoint((float)58.3, (float)60.7));
            list.Add(MapHelper.AddPoint((float)51.3, (float)68.3));
            list.Add(MapHelper.AddPoint((float)46.4, (float)72.8));
            list.Add(MapHelper.AddPoint((float)39.6, (float)77.6));
            list.Add(MapHelper.AddPoint((float)29.4, (float)86.0));
            list.Add(MapHelper.AddPoint((float)20.1, (float)90.2));
            list.Add(MapHelper.AddPoint((float)11.7, (float)93.2));
            list.Add(MapHelper.AddPoint((float)2.1, (float)95.0));
            list.Add(MapHelper.AddPoint((float)-6.8, (float)95.9));
            list.Add(MapHelper.AddPoint((float)-16.4, (float)96.2));
            list.Add(MapHelper.AddPoint((float)-24.2, (float)95.3));
            list.Add(MapHelper.AddPoint((float)-31.8, (float)94.1));
            list.Add(MapHelper.AddPoint((float)-39.8, (float)92.0));
            list.Add(MapHelper.AddPoint((float)-50.8, (float)86.9));
            list.Add(MapHelper.AddPoint((float)-58.1, (float)82.4));
            list.Add(MapHelper.AddPoint((float)-66.9, (float)76.4));
            list.Add(MapHelper.AddPoint((float)-74.5, (float)70.4));
            list.Add(MapHelper.AddPoint((float)-83.6, (float)60.4));
            list.Add(MapHelper.AddPoint((float)-88.5, (float)55.9));
            list.Add(MapHelper.AddPoint((float)-95.8, (float)45.1));
            list.Add(MapHelper.AddPoint((float)-102.3, (float)37.3));
            list.Add(MapHelper.AddPoint((float)-109.6, (float)27.7));
            list.Add(MapHelper.AddPoint((float)-118.0, (float)13.8));
            list.Add(MapHelper.AddPoint((float)-125.3, (float)0.3));
            list.Add(MapHelper.AddPoint((float)-134.1, (float)-15.6));
            list.Add(MapHelper.AddPoint((float)-141.9, (float)-29.8));
            list.Add(MapHelper.AddPoint((float)-146.4, (float)-40.9));
            list.Add(MapHelper.AddPoint((float)-149.9, (float)-48.1));
            list.Add(MapHelper.AddPoint((float)-149.9, (float)-49.6));
        ...
        public static Il2CppReferenceArray<PointInfo> secondTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)35.4, (float)-77.6));
            list.Add(MapHelper.AddPoint((float)42.2, (float)-74.3));
            list.Add(MapHelper.AddPoint((float)51.0, (float)-71.0));
            list.Add(MapHelper.AddPoint((float)61.5, (float)-66.5));
            list.Add(MapHelper.AddPoint((float)69.0, (float)-62.5));
            list.Add(MapHelper.AddPoint((float)76.0, (float)-58.6));
            list.Add(MapHelper.AddPoint((float)85.9, (float)-53.5));
            list.Add(MapHelper.AddPoint((float)91.9, (float)-49.9));
            list.Add(MapHelper.AddPoint((float)101.0, (float)-43.3));
            list.Add(MapHelper.AddPoint((float)108.1, (float)-37.6));
            list.Add(MapHelper.AddPoint((float)115.1, (float)-32.2));
            list.Add(MapHelper.AddPoint((float)119.3, (float)-27.4));
            list.Add(MapHelper.AddPoint((float)127.6, (float)-18.0));
            list.Add(MapHelper.AddPoint((float)133.3, (float)-11.4));
            list.Add(MapHelper.AddPoint((float)140.1, (float)-3.9));
            list.Add(MapHelper.AddPoint((float)145.8, (float)3.0));
            list.Add(MapHelper.AddPoint((float)150.1, (float)9.0));
            list.Add(MapHelper.AddPoint((float)150.1, (float)13.2));
        ...
        public static Il2CppReferenceArray<AreaModel> areas()
        {
            ...
            newAreas.Add(new AreaModel("trunk0", new Assets.Scripts.Simulation.SMath.Polygon(trunk), 100, AreaType.unplaceable, 0f, null, null, null, true, false, default));
            ...
            newAreas.Add(new AreaModel("bush3", new Assets.Scripts.Simulation.SMath.Polygon(bush3), 100, AreaType.unplaceable, 0f, null, null, null, true, false, default));
