...
namespace BTDBattles2Maps.Maps
{
    class InTheWall
    {
        public static Il2CppReferenceArray<PointInfo> mainTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)-31.5, (float)115.5));
            list.Add(MapHelper.AddPoint((float)-30.5, (float)84.5));
            list.Add(MapHelper.AddPoint((float)-33.6, (float)80.0));
            list.Add(MapHelper.AddPoint((float)-63.5, (float)78.5));
            list.Add(MapHelper.AddPoint((float)-65.9, (float)77.9));
            list.Add(MapHelper.AddPoint((float)-68.0, (float)74.0));
            list.Add(MapHelper.AddPoint((float)-68.0, (float)62.8));
            list.Add(MapHelper.AddPoint((float)-69.8, (float)58.0));
            list.Add(MapHelper.AddPoint((float)-72.7, (float)57.1));
            list.Add(MapHelper.AddPoint((float)-100.5, (float)56.2));
            list.Add(MapHelper.AddPoint((float)-104.9, (float)55.0));
            list.Add(MapHelper.AddPoint((float)-107.0, (float)52.3));
            list.Add(MapHelper.AddPoint((float)-107.0, (float)40.3));
            list.Add(MapHelper.AddPoint((float)-108.1, (float)37.6));
            list.Add(MapHelper.AddPoint((float)-110.7, (float)33.1));
            list.Add(MapHelper.AddPoint((float)-134.9, (float)32.5));
            list.Add(MapHelper.AddPoint((float)-139.6, (float)31.0));
            list.Add(MapHelper.AddPoint((float)-140.9, (float)28.3));
            list.Add(MapHelper.AddPoint((float)-141.4, (float)8.7));
            list.Add(MapHelper.AddPoint((float)-139.8, (float)5.1));
            list.Add(MapHelper.AddPoint((float)-135.7, (float)3.6));
            list.Add(MapHelper.AddPoint((float)-29.4, (float)3.0));
            list.Add(MapHelper.AddPoint((float)-25.5, (float)3.3));
            list.Add(MapHelper.AddPoint((float)-22.9, (float)-0.6));
            list.Add(MapHelper.AddPoint((float)-22.1, (float)-19.8));
            list.Add(MapHelper.AddPoint((float)-22.1, (float)-23.8));
            list.Add(MapHelper.AddPoint((float)-25.8, (float)-27.7));
            list.Add(MapHelper.AddPoint((float)-140.6, (float)-30.7));
            list.Add(MapHelper.AddPoint((float)-141.1, (float)-35.2));
            list.Add(MapHelper.AddPoint((float)-140.4, (float)-51.1));
            list.Add(MapHelper.AddPoint((float)-139.3, (float)-55.9));
            list.Add(MapHelper.AddPoint((float)-137.8, (float)-57.1));
            list.Add(MapHelper.AddPoint((float)-113.8, (float)-58.3));
            list.Add(MapHelper.AddPoint((float)-109.4, (float)-59.2));
            list.Add(MapHelper.AddPoint((float)-108.1, (float)-61.3));
            list.Add(MapHelper.AddPoint((float)-106.8, (float)-76.4));
            list.Add(MapHelper.AddPoint((float)-105.2, (float)-79.4));
            list.Add(MapHelper.AddPoint((float)-102.1, (float)-81.8));
            list.Add(MapHelper.AddPoint((float)-74.5, (float)-82.4));
            list.Add(MapHelper.AddPoint((float)-71.1, (float)-83.3));
            list.Add(MapHelper.AddPoint((float)-69.8, (float)-85.4));
            list.Add(MapHelper.AddPoint((float)-68.5, (float)-97.4));
            list.Add(MapHelper.AddPoint((float)-67.7, (float)-100.7));
            list.Add(MapHelper.AddPoint((float)-63.5, (float)-103.7));
            list.Add(MapHelper.AddPoint((float)60.2, (float)-104.6));
            list.Add(MapHelper.AddPoint((float)64.1, (float)-103.1));
            list.Add(MapHelper.AddPoint((float)67.7, (float)-99.2));
            list.Add(MapHelper.AddPoint((float)69.0, (float)-86.9));
            list.Add(MapHelper.AddPoint((float)70.8, (float)-83.9));
            list.Add(MapHelper.AddPoint((float)73.4, (float)-82.7));
            list.Add(MapHelper.AddPoint((float)100.8, (float)-81.5));
            list.Add(MapHelper.AddPoint((float)103.1, (float)-80.9));
            list.Add(MapHelper.AddPoint((float)105.2, (float)-78.5));
            list.Add(MapHelper.AddPoint((float)108.1, (float)-63.1));
            list.Add(MapHelper.AddPoint((float)107.8, (float)-60.7));
            list.Add(MapHelper.AddPoint((float)110.7, (float)-58.9));
            list.Add(MapHelper.AddPoint((float)135.7, (float)-58.3));
            list.Add(MapHelper.AddPoint((float)139.8, (float)-56.8));
            list.Add(MapHelper.AddPoint((float)140.4, (float)-54.1));
            list.Add(MapHelper.AddPoint((float)141.7, (float)-35.2));
            list.Add(MapHelper.AddPoint((float)141.1, (float)-32.2));
            list.Add(MapHelper.AddPoint((float)134.9, (float)-31.0));
            list.Add(MapHelper.AddPoint((float)30.5, (float)-28.6));
            list.Add(MapHelper.AddPoint((float)24.7, (float)-27.4));
            list.Add(MapHelper.AddPoint((float)23.4, (float)-25.0));
            list.Add(MapHelper.AddPoint((float)22.1, (float)-3.3));
            list.Add(MapHelper.AddPoint((float)22.4, (float)0.0));
            list.Add(MapHelper.AddPoint((float)25.3, (float)1.8));
            list.Add(MapHelper.AddPoint((float)134.9, (float)3.0));
            list.Add(MapHelper.AddPoint((float)140.1, (float)4.2));
            list.Add(MapHelper.AddPoint((float)141.4, (float)7.2));
            list.Add(MapHelper.AddPoint((float)140.4, (float)28.0));
            list.Add(MapHelper.AddPoint((float)137.5, (float)30.7));
            list.Add(MapHelper.AddPoint((float)133.6, (float)31.3));
            list.Add(MapHelper.AddPoint((float)112.0, (float)32.2));
            list.Add(MapHelper.AddPoint((float)109.1, (float)33.7));
            list.Add(MapHelper.AddPoint((float)108.6, (float)36.7));
            list.Add(MapHelper.AddPoint((float)107.6, (float)49.3));
            list.Add(MapHelper.AddPoint((float)107.0, (float)52.3));
            list.Add(MapHelper.AddPoint((float)103.1, (float)55.9));
            list.Add(MapHelper.AddPoint((float)75.5, (float)57.4));
            list.Add(MapHelper.AddPoint((float)72.1, (float)57.4));
            list.Add(MapHelper.AddPoint((float)70.1, (float)60.4));
            list.Add(MapHelper.AddPoint((float)68.2, (float)73.4));
            list.Add(MapHelper.AddPoint((float)66.9, (float)77.0));
            list.Add(MapHelper.AddPoint((float)64.1, (float)78.5));
            list.Add(MapHelper.AddPoint((float)39.6, (float)79.7));
            list.Add(MapHelper.AddPoint((float)35.9, (float)79.4));
            list.Add(MapHelper.AddPoint((float)32.8, (float)81.2));
            list.Add(MapHelper.AddPoint((float)31.5, (float)85.7));
            list.Add(MapHelper.AddPoint((float)31.3, (float)115.5));
