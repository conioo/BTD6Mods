...
namespace BTDBattles2Maps.Maps
{
    class Docks
    {
        public static Il2CppReferenceArray<PointInfo> mainTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)-149.9, (float)104.3));
            list.Add(MapHelper.AddPoint((float)-89.3, (float)106.4));
            list.Add(MapHelper.AddPoint((float)-84.6, (float)104.0));
            list.Add(MapHelper.AddPoint((float)-82.8, (float)100.7));
            list.Add(MapHelper.AddPoint((float)-81.2, (float)56.8));
            list.Add(MapHelper.AddPoint((float)-83.3, (float)52.9));
            list.Add(MapHelper.AddPoint((float)-85.7, (float)51.1));
            list.Add(MapHelper.AddPoint((float)-107.8, (float)50.8));
            list.Add(MapHelper.AddPoint((float)-110.2, (float)50.8));
            list.Add(MapHelper.AddPoint((float)-110.9, (float)49.0));
            list.Add(MapHelper.AddPoint((float)-112.0, (float)47.8));
            list.Add(MapHelper.AddPoint((float)-112.2, (float)10.5));
            list.Add(MapHelper.AddPoint((float)-111.5, (float)7.5));
            list.Add(MapHelper.AddPoint((float)-107.6, (float)4.8));
            list.Add(MapHelper.AddPoint((float)-84.6, (float)4.5));
            list.Add(MapHelper.AddPoint((float)-83.6, (float)3.0));
            list.Add(MapHelper.AddPoint((float)-81.5, (float)-1.2));
            list.Add(MapHelper.AddPoint((float)-81.5, (float)-42.1));
            list.Add(MapHelper.AddPoint((float)-83.1, (float)-46.3));
            list.Add(MapHelper.AddPoint((float)-85.9, (float)-48.7));
            list.Add(MapHelper.AddPoint((float)-108.3, (float)-49.3));
            list.Add(MapHelper.AddPoint((float)-111.2, (float)-50.8));
            list.Add(MapHelper.AddPoint((float)-112.2, (float)-55.3));
            list.Add(MapHelper.AddPoint((float)-112.0, (float)-90.5));
            list.Add(MapHelper.AddPoint((float)-112.0, (float)-93.8));
            list.Add(MapHelper.AddPoint((float)-108.1, (float)-95.6));
            list.Add(MapHelper.AddPoint((float)10.2, (float)-96.2));
            list.Add(MapHelper.AddPoint((float)8.1, (float)-94.4));
            list.Add(MapHelper.AddPoint((float)10.7, (float)-91.4));
            list.Add(MapHelper.AddPoint((float)10.2, (float)-56.2));
            list.Add(MapHelper.AddPoint((float)9.6, (float)-52.0));
            list.Add(MapHelper.AddPoint((float)6.0, (float)-49.3));
            list.Add(MapHelper.AddPoint((float)-14.8, (float)-49.6));
            list.Add(MapHelper.AddPoint((float)-19.5, (float)-47.5));
            list.Add(MapHelper.AddPoint((float)-20.8, (float)-43.3));
            list.Add(MapHelper.AddPoint((float)-21.1, (float)-3.6));
            list.Add(MapHelper.AddPoint((float)-19.8, (float)0.0));
            list.Add(MapHelper.AddPoint((float)-15.6, (float)2.4));
            list.Add(MapHelper.AddPoint((float)5.7, (float)4.5));
            list.Add(MapHelper.AddPoint((float)8.3, (float)6.9));
            list.Add(MapHelper.AddPoint((float)10.4, (float)10.2));
            list.Add(MapHelper.AddPoint((float)10.9, (float)44.8));
            list.Add(MapHelper.AddPoint((float)10.2, (float)48.7));
            list.Add(MapHelper.AddPoint((float)6.2, (float)51.1));
            list.Add(MapHelper.AddPoint((float)-13.8, (float)51.7));
            list.Add(MapHelper.AddPoint((float)-18.2, (float)52.9));
            list.Add(MapHelper.AddPoint((float)-20.1, (float)56.5));
            list.Add(MapHelper.AddPoint((float)-20.6, (float)99.2));
            list.Add(MapHelper.AddPoint((float)-19.3, (float)103.1));
            list.Add(MapHelper.AddPoint((float)-16.7, (float)104.9));
            list.Add(MapHelper.AddPoint((float)99.5, (float)105.5));
            list.Add(MapHelper.AddPoint((float)102.3, (float)104.3));
            list.Add(MapHelper.AddPoint((float)103.4, (float)102.2));
            list.Add(MapHelper.AddPoint((float)104.9, (float)98.3));
            list.Add(MapHelper.AddPoint((float)105.2, (float)59.5));
            list.Add(MapHelper.AddPoint((float)103.4, (float)55.3));
            list.Add(MapHelper.AddPoint((float)101.0, (float)52.0));
            list.Add(MapHelper.AddPoint((float)81.5, (float)51.1));
            list.Add(MapHelper.AddPoint((float)76.6, (float)49.3));
            list.Add(MapHelper.AddPoint((float)74.7, (float)45.7));
            list.Add(MapHelper.AddPoint((float)74.2, (float)12.9));
            list.Add(MapHelper.AddPoint((float)76.0, (float)5.1));
            list.Add(MapHelper.AddPoint((float)99.5, (float)3.6));
            list.Add(MapHelper.AddPoint((float)103.4, (float)0.9));
            list.Add(MapHelper.AddPoint((float)104.7, (float)-39.7));
            list.Add(MapHelper.AddPoint((float)103.4, (float)-45.7));
            list.Add(MapHelper.AddPoint((float)99.2, (float)-48.4));
            list.Add(MapHelper.AddPoint((float)80.7, (float)-49.0));
            list.Add(MapHelper.AddPoint((float)75.8, (float)-49.9));
            list.Add(MapHelper.AddPoint((float)74.5, (float)-53.8));
            list.Add(MapHelper.AddPoint((float)74.7, (float)-91.4));
            list.Add(MapHelper.AddPoint((float)77.1, (float)-94.4));
            list.Add(MapHelper.AddPoint((float)150.0, (float)-95.6));
