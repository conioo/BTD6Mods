...
namespace BTDBattles2Maps.Maps
{
    class DinoGraveyard
    {
        public static Il2CppReferenceArray<PointInfo> mainTrack()
        {
            ...
            list.Add(MapHelper.AddPoint((float)-134.9, (float)-115.2));
            list.Add(MapHelper.AddPoint((float)-135.7, (float)-95.6));
            list.Add(MapHelper.AddPoint((float)-135.7, (float)-74.9));
            list.Add(MapHelper.AddPoint((float)-134.4, (float)-52.9));
            list.Add(MapHelper.AddPoint((float)-134.1, (float)-37.3));
            list.Add(MapHelper.AddPoint((float)-128.9, (float)-22.3));
            list.Add(MapHelper.AddPoint((float)-124.5, (float)-12.9));
            list.Add(MapHelper.AddPoint((float)-119.3, (float)-5.1));
            list.Add(MapHelper.AddPoint((float)-113.3, (float)0.9));
            list.Add(MapHelper.AddPoint((float)-107.6, (float)6.0));
            list.Add(MapHelper.AddPoint((float)-101.3, (float)9.3));
            list.Add(MapHelper.AddPoint((float)-98.2, (float)10.5));
            list.Add(MapHelper.AddPoint((float)-93.0, (float)13.8));
            list.Add(MapHelper.AddPoint((float)-85.7, (float)15.0));
            list.Add(MapHelper.AddPoint((float)-78.1, (float)15.6));
            list.Add(MapHelper.AddPoint((float)-72.1, (float)15.6));
            list.Add(MapHelper.AddPoint((float)-64.6, (float)14.4));
            list.Add(MapHelper.AddPoint((float)-56.5, (float)11.4));
            list.Add(MapHelper.AddPoint((float)-48.7, (float)8.1));
            list.Add(MapHelper.AddPoint((float)-42.4, (float)3.6));
            list.Add(MapHelper.AddPoint((float)-35.9, (float)-1.8));
            list.Add(MapHelper.AddPoint((float)-29.2, (float)-7.8));
            list.Add(MapHelper.AddPoint((float)-25.0, (float)-14.4));
            list.Add(MapHelper.AddPoint((float)-20.8, (float)-20.4));
            list.Add(MapHelper.AddPoint((float)-17.4, (float)-28.3));
            list.Add(MapHelper.AddPoint((float)-15.9, (float)-36.1));
            list.Add(MapHelper.AddPoint((float)-14.1, (float)-46.6));
            list.Add(MapHelper.AddPoint((float)-12.5, (float)-56.8));
            list.Add(MapHelper.AddPoint((float)-11.7, (float)-64.7));
            list.Add(MapHelper.AddPoint((float)-10.7, (float)-70.7));
            list.Add(MapHelper.AddPoint((float)-10.9, (float)-75.2));
            list.Add(MapHelper.AddPoint((float)-10.7, (float)-78.5));
            list.Add(MapHelper.AddPoint((float)-9.9, (float)-80.3));
            list.Add(MapHelper.AddPoint((float)-8.1, (float)-82.1));
            list.Add(MapHelper.AddPoint((float)-6.0, (float)-83.3));
            list.Add(MapHelper.AddPoint((float)-2.6, (float)-84.5));
            list.Add(MapHelper.AddPoint((float)9.9, (float)-86.3));
            list.Add(MapHelper.AddPoint((float)24.2, (float)-86.3));
            list.Add(MapHelper.AddPoint((float)45.8, (float)-85.1));
            list.Add(MapHelper.AddPoint((float)104.4, (float)-86.6));
            list.Add(MapHelper.AddPoint((float)107.8, (float)-86.0));
            list.Add(MapHelper.AddPoint((float)109.9, (float)-84.8));
            list.Add(MapHelper.AddPoint((float)112.0, (float)-83.0));
            list.Add(MapHelper.AddPoint((float)113.8, (float)-81.5));
            list.Add(MapHelper.AddPoint((float)115.1, (float)-79.4));
            list.Add(MapHelper.AddPoint((float)116.4, (float)-76.4));
            list.Add(MapHelper.AddPoint((float)116.4, (float)-74.0));
            list.Add(MapHelper.AddPoint((float)118.5, (float)25.3));
            list.Add(MapHelper.AddPoint((float)119.5, (float)32.5));
            list.Add(MapHelper.AddPoint((float)118.5, (float)39.4));
            list.Add(MapHelper.AddPoint((float)117.2, (float)47.2));
            list.Add(MapHelper.AddPoint((float)115.1, (float)56.8));
            list.Add(MapHelper.AddPoint((float)111.2, (float)66.2));
            list.Add(MapHelper.AddPoint((float)106.3, (float)75.8));
            list.Add(MapHelper.AddPoint((float)100.0, (float)84.8));
            list.Add(MapHelper.AddPoint((float)91.4, (float)91.4));
            list.Add(MapHelper.AddPoint((float)84.6, (float)95.6));
            list.Add(MapHelper.AddPoint((float)76.8, (float)99.8));
            list.Add(MapHelper.AddPoint((float)70.8, (float)101.9));
            list.Add(MapHelper.AddPoint((float)61.7, (float)103.4));
            list.Add(MapHelper.AddPoint((float)51.0, (float)102.5));
            list.Add(MapHelper.AddPoint((float)43.0, (float)100.7));
            list.Add(MapHelper.AddPoint((float)33.9, (float)95.9));
            list.Add(MapHelper.AddPoint((float)29.2, (float)91.4));
            list.Add(MapHelper.AddPoint((float)21.6, (float)85.1));
            list.Add(MapHelper.AddPoint((float)17.2, (float)79.1));
            list.Add(MapHelper.AddPoint((float)11.5, (float)72.5));
            list.Add(MapHelper.AddPoint((float)8.1, (float)67.4));
            list.Add(MapHelper.AddPoint((float)3.1, (float)61.0));
            list.Add(MapHelper.AddPoint((float)-1.3, (float)57.4));
            list.Add(MapHelper.AddPoint((float)-6.5, (float)54.7));
            list.Add(MapHelper.AddPoint((float)-12.8, (float)54.1));
            list.Add(MapHelper.AddPoint((float)-19.0, (float)52.9));
            list.Add(MapHelper.AddPoint((float)-149.9, (float)54.1));
